...
void VtbGenericVga___024root___eval_triggers__act(VtbGenericVga___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.setBit(1U, ((IData)(vlSelfRef.tbGenericVga__DOT__dut__DOT__reset) 
                                          & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tbGenericVga__DOT__dut__DOT__reset__0))));
    vlSelfRef.__VactTriggered.setBit(2U, ((IData)(vlSelfRef.tbGenericVga__DOT__dut__DOT__raytracer_core__DOT__pixel_clock) 
                                          & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tbGenericVga__DOT__dut__DOT__raytracer_core__DOT__pixel_clock__0))));
